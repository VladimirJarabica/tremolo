  ...
  return (
    <div className="flex h-screen flex-col">
      ...
      <div className="flex flex-1 mt-14 print:mt-0 relative">
        ...
        <aside
          className={cn(
            "fixed inset-y-0 print:hidden top-0 lg:top-14 left-0 z-50 w-72 transform border-r border-border backdrop-blur-xl transition-transform duration-200 ease-in-out lg:static lg:z-auto lg:translate-x-0",
            "bg-card/80 shadow-lg shadow-primary/5",
